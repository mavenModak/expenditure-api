...
public class UserRepositoryImpl implements UserRepository{
    ...
    @Override
    public Integer create(String firstName, String lastName, String email, String password) throws MtAuthException {
    ...
    public User findByEmailAndPassword(String email, String password) throws MtAuthException {
        ...
        try{
            ...
            if(!BCrypt.checkpw(password,user.getPassword()))
                throw new MtAuthException("Invalid password. Please try again.");
            return user;
